class GameScene extends Scene {
    ...
    constructor(game) {
        ...
        this.weapons = [
            ...
            WeaponFactory.createMineWeapon(Entity.GENERATE_ID(), this.playerID, this.entities),
    ...
    createUI() {
        ...
        playAgainC[MouseInteractableComponent].listeners.mouseup.push(() => {
            ...
            for (let entityID of Object.keys(this.entities)) {
                if (this.entities[entityID][HealthComponent]) {
    ...
    repositionWeaponCrate() {
        ...
        let spawnLine = this.prevSpawnLine;
        while (spawnLine == this.prevSpawnLine) {
            spawnLine = this.crateSpawnLines[Math.floor(Math.random() * this.crateSpawnLines.length)];
        }
        this.prevSpawnLine = spawnLine;
